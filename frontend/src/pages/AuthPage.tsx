...
const AuthPage: React.FC = () => {
  const { authState, login, register, updateAuthStateError } = useAuth();
  ...
  console.log("errors", registerError, authState);
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-4">
      <Card className="w-[350px] animate-fade-in">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Manage your content and earn credits
          </CardDescription>
        </CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      href="#"
                      className="text-xs text-creator-primary hover:underline"
                    >
                      Forgot password?
                    </a>
                  </div>
